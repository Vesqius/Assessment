...
import sty from "./PlasmicButton.module.css"; // plasmic-import: lLYWjqtwRPx/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: BPItZMTAkH2/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: tOcNuFr5mYf/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__eFma8)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__nb81K)}
                role={"img"}
              />
            ),
