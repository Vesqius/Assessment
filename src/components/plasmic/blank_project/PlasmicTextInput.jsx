...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: vsBMPoBaWTY/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: YVBvQ8x2dRJ/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: BPItZMTAkH2/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__kJgd5)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__e1ZVy)}
                role={"img"}
              />
            ),
